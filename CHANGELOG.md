...
### Changed
- Bump POS Next version after adding the Payments & Expenses quick action.
...
### Fixed
- Restrict cancel and delete permissions for Sales Invoice and Payment Entry to administrators.

## [1.16.7] - 2026-05-17

### Added
- Add native Android Bluetooth ESC/POS printing support for paired receipt printers.
